...
export default function DeleteAgentModal({ open, onOpenChange, agent, setReload }) {
    ...
    const submitDeleteForm = (e) => {
        e.preventDefault()
        toast.promise(
            () => axiosInstance.delete(apiRoutes.deleteAgent(agent.id)),
            {
                loading: `Suppression en cours de l'agent ${agent?.nom}...`,
                success: (res) => {
                ...
                <DialogContent className="sm:max-w-sm text-center">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            ...
                            L'agent <span className="badge bg-light border rounded text-dark"> {agent?.nom}</span> sera supprimé définitivement.
                        </DialogDescription>
                    </DialogHeader>
