...
export default function DeleteApprovisionnementModal({ open, onOpenChange, approvisionnement, setReload }) {
    ...
    const submitDeleteForm = (e) => {
        e.preventDefault()
        toast.promise(
            () => axiosInstance.delete(apiRoutes.deleteApprovisionnement(approvisionnement.id)),
            {
                ...
                <DialogContent className="sm:max-w-sm text-center">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            ...
                            Cet approvisionnement <span className="badge bg-light border rounded text-dark"> {approvisionnement?.code}</span> sera supprimé définitivement.
                        </DialogDescription>
                    </DialogHeader>
