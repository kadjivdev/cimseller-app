...
export default function DeleteClientModal({ open, onOpenChange, client, setReload }) {
    ...
    const submitDeleteForm = (e) => {
        e.preventDefault()
        toast.promise(
            () => axiosInstance.delete(apiRoutes.deleteClient(client.id)),
            {
                loading: `Suppression en cours du produit ${client?.raison_sociale}...`,
                success: (data) => {
                ...
                <DialogContent className="sm:max-w-sm text-center">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            ...
                            Le client <span className="badge bg-light border rounded text-dark"> {client?.raison_sociale}</span> sera supprimée définitivement.
                        </DialogDescription>
                    </DialogHeader>
