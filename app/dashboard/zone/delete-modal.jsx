...
export default function DeleteUserModal({ open, onOpenChange, user, setReload }) {
    ...
    const submitDeleteForm = (e) => {
        e.preventDefault()
        toast.promise(
            () => axiosInstance.delete(apiRoutes.deleteUser(user.id)),
            {
                ...
                <DialogContent className="sm:max-w-sm text-center">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            ...
                            Le compte de l'utilisateur <span className="badge bg-light border rounded text-dark"> {user?.fullname}</span> sera supprimé définitivement.
                        </DialogDescription>
                    </DialogHeader>
