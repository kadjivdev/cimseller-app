...
export function useColumns(onEdit: (banque: Banque) => void, onDelete: (banque: Banque) => void): ColumnDef<Banque>[] {
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem
                ...
                onSelect={(e) => {
                  e.preventDefault()
                  onEdit(banque) // 👈 remonte juste le role
                }}
              >
                <PencilLine /> Modifier
              </DropdownMenuItem>
              ...
              <DropdownMenuItem
                ...
                onSelect={(e) => {
                  e.preventDefault()
                  onDelete(banque) // 👈 remonte juste le role
                }}>
                <Eraser /> Supprimer
              </DropdownMenuItem>
            </DropdownMenuContent>
