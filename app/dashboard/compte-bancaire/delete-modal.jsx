...
export default function DeleteZoneModal({ open, onOpenChange, compteBancaire, setReload }) {
    ...
    const submitDeleteForm = (e) => {
        e.preventDefault()
        toast.promise(
            () => axiosInstance.delete(apiRoutes.deleteCompteBancaire(compteBancaire.id)),
            {
                ...
                <DialogContent className="sm:max-w-sm text-center">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            ...
                            Le compte bancaire <span className="badge bg-light border rounded text-dark"> {compteBancaire?.intitule}</span> sera supprimée définitivement.
                        </DialogDescription>
                    </DialogHeader>
