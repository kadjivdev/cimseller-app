...
import { Download, HandCoins, List, Printer, ShoppingCart } from 'lucide-react';
...
export default function index() {
    ...
    useEffect(() => {
        ...
        toast.promise(
            ...
            {
                loading: 'Chargement des ventes traitées ...',
                success: (res) => {
    ...
    return <>
        <DashboardLayourt title="Exporter les ventes déjà traitées" icon={<Download />}>
            {/* listes des ventes traitées */}
