...
import { ArrowUpDown, CircleCheckBig, Eraser, Eye, MoreHorizontal, PencilLine, Van } from "lucide-react"
...
export function useColumns(
  ...
  return [
        ...
        return (
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                ...
                {/* modifier */}
                {(!vente.validatedBy && isPermittedTo("vente.edit")) &&
                  <DropdownMenuItem
                ...
                {/* valider */}
                {(!vente.validatedBy && isPermittedTo("vente.validate")) &&
                  <DropdownMenuItem
                    style={{ cursor: "pointer" }}
                ...
                {/* suppression */}
                {(!vente.validatedBy && isPermittedTo("vente.delete")) &&
                  <DropdownMenuItem
                    style={{ cursor: "pointer" }}
    ...
    },
    {
      ...
      // ✅ Ajouter cell
      cell: ({ row }) => <div className="d-flex justify-content-center">{ row.original?.preuve? <Link target="_blank" href={row.original?.preuve} className="text-dark"><Eye/></Link>:'---'}</div>
    },
    {
