...
export function useColumns(onEdit: (fournisseur: Fournisseur) => void, onDelete: (fournisseur: Fournisseur) => void): ColumnDef<Fournisseur>[] {
  ...
  return [
    ...
    },
    {
      ...
      header: ({ column }) => (
        <Button className="w-100" variant="ghost" onClick={() => column.toggleSorting(column.getIsSorted() === "asc")}>
          Sigle <ArrowUpDown className="ml-2 h-4 w-4" />
        </Button>
      ),
      // ✅ Ajouter cell
      cell: ({ row }) => row.getValue("sigle") || "—",
    },
    {
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem
                ...
                onSelect={(e) => {
                  e.preventDefault()
                  onEdit(fournisseur) // 👈 remonte juste le fournisseur
                }}
              >
                <PencilLine /> Modifier
              </DropdownMenuItem>
              ...
              <DropdownMenuItem
                ...
                onSelect={(e) => {
                  e.preventDefault()
                  onDelete(fournisseur) // 👈 remonte juste le fournisseur
                }}>
                <Eraser /> Supprimer
              </DropdownMenuItem>
            </DropdownMenuContent>
