...
import { useColumns, Avaliseur } from "../avaliseur/columns"
...
import UpdateAvaliseurModal from "./modal"
import DeleteAvaliseurModal from "./delete-modal"
...
export function DataTable({ data, setReload }) {
    ...
    const [selectedAvaliseur, setSelectedAvaliseur] = useState<Avaliseur | null>(null)
    ...
    // 
    const handleEdit = (avaliseur: Avaliseur) => {
        setSelectedAvaliseur(avaliseur)
        setOpen(true)
    }

    const handleDelete = (avaliseur: Avaliseur) => {
        setSelectedAvaliseur(avaliseur)
        setOpenDelete(true)
    }
    ...
    return (
        <>
            ...
            <UpdateAvaliseurModal
                open={open}
                onOpenChange={setOpen}
                avaliseur={selectedAvaliseur}
                setReload={setReload}
            />

            <DeleteAvaliseurModal
                open={openDelete}
