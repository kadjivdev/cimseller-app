...
// modals
import DeliveryProgrammationModal from "./delivery-modal"
import TransferProgrammationModal from "./transfer-modal"
import CloseProgrammationModal from "./close-modal"
...
export function DataTable({ data, setReload, date, setDate, handleBonSelect }) {
    ...
    // 
    const handleDelivery = (programmation: Programmation) => {
        setSelectedProgrammation(programmation)
        setOpenDelivery(true)
    }

    const handleTransfer = (programmation: Programmation) => {
        setSelectedProgrammation(programmation)
        setOpenTransfer(true)
    }

    const handleClose = (programmation: Programmation) => {
        setSelectedProgrammation(programmation)
        setOpenClose(true)
    }

    const columns = useColumns(handleDelivery, handleTransfer, handleClose) // 👈 passe les callbacks
    ...
    return (
        <>
            ...
            {/* delivery programmation */}
            <DeliveryProgrammationModal
                open={openDelivery}
            ...
            {/* cloturer programmation */}
            <CloseProgrammationModal
                open={openClose}
