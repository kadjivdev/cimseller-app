...
export default function CloseProgrammationModal({ open, onOpenChange, programmation, handleBonSelect }) {
        ...
        <form onSubmit={submitUpdateForm}>
          ...
          <DialogFooter>
            ...
            <Button
              ...
              disabled={!data.dateSortie && !data.bl}
