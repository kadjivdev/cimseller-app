...
export default function DeleteChauffeurModal({ open, onOpenChange, chauffeur, setReload }) {
    ...
    const submitDeleteForm = (e) => {
        e.preventDefault()
        toast.promise(
            () => axiosInstance.delete(apiRoutes.deleteChauffeur(chauffeur.id)),
            {
                loading: `Suppression en cours du chauffeur ${chauffeur?.fullname}...`,
                success: (res) => {
